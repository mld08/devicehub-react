        ...
        <main>
            ...
            {selectedProduct && (
                <div className="fixed inset-0 flex items-center justify-center" style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} onClick={() => setSelectedProduct(null)}>
                    <div className="bg-white max-w-4xl mx-auto p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center justify-around gap-6 relative">
                        ...
                        <div className="w-full md:w-3/5 overflow-x-auto mt-10">
